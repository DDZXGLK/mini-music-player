<template>
  <div class="music">
    <el-row>
      ...
      <el-col :span="8">
        <el-autocomplete :placeholder="defaultKeyWorlds ? defaultKeyWorlds : '请输入歌曲信息'" v-model="keywords"
          :fetch-suggestions="getSearchHot" clearable @keyup.enter="getMusicList"></el-autocomplete>
      </el-col>
      <el-col :span="4">
        <el-button type="primary" @click="getMusicList">
          <Search style="width: 1em; height: 1em" />搜索
        </el-button>
      </el-col>
      <el-col :span="6"></el-col>
    </el-row>
    <el-table :data="musicData" border :row-style="rowStyle" rowKey="id" max-height="600" highlight-current-row
      @row-dblclick="listen" getSelectionRows>
      <template #empty>
    ...
    <el-pagination background :total="total" v-model:page-size="pageSize" v-model:current-page="current"
      :page-sizes="[10, 20, 30, 40, 50]" layout="total, sizes, prev, pager, next, jumper"
      @update:current-page="getMusicList" @update:page-size="getMusicList">
    </el-pagination>
